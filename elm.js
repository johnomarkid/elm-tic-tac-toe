...
Elm.Main.make = function (_elm) {
   ...
   var fromJust = function (x) {
      ...
      if (_p0.ctor === "Just") {
            ...
            return _U.crashCase("Main",{start: {line: 122,column: 3},end: {line: 127,column: 44}},_p0)("error: fromJust Nothing");
         }
   };
   ...
   var checkWin = function (model) {
      ...
      var scoreBoard = A2($Debug.log,"board: ",A2(createScoreboard,model.turn,model.board));
   ...
   var initialModel = function (bs) {    return {board: initialBoard(bs),turn: X,status: Ongoing,boardSize: bs};};
   var update = F2(function (action,model) {
      var _p7 = action;
      switch (_p7.ctor)
      {case "NoOp": return model;
         case "Reset": return initialModel(2);
         case "IncreaseBoard": return initialModel(model.boardSize + 1);
         default: var newModel = function (aModel) {    return changeTurn(aModel);}(checkWin(A2(updateSquare,_p7._0,model)));
           return newModel;}
   });
   var model = A3($Signal.foldp,update,initialModel(2),actions.signal);
   var main = A2($Signal.map,view(actions.address),model);
   var Model = F4(function (a,b,c,d) {    return {board: a,turn: b,status: c,boardSize: d};});
